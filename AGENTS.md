...
**V1 feature-complete (2026-09-03).** All 7 milestones implemented; 19 offline test suites
green; clean `-Wall -Wextra -Wpedantic -Werror` build (Qt 6.6.2 / MinGW 11.2.0 / Ninja).
